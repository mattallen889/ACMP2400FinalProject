...
resource "azurerm_container_group" "mattallen-aci" {
  name = "acmp-mattallen-aci"
  location = "Central US"
  resource_group_name = "rg-mattallen"
  ip_address_type = "Public"
  dns_name_label = "acmp-mattallen-instance"
  os_type = "Linux"

  container {
    name = "final"
    image = "acrmattallenacmp2400.azurecr.io/final:latest"
    cpu = "0.5"
    memory = "1.5"
  ...
  image_registry_credentials {
    server = "acrmattallenacmp2400.azurecr.io"
